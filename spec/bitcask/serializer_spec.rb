RSpec.describe Bitcask::Serializer do
    ...
    describe '#deserialize' do
        let(:serialized_data) do 
            OpenStruct.new(raw: "\xCEi\x94\x03}\xA7\xA8c\x05\x00\x00\x00\t\x00\x00\x00animeOne Piece", epoc: 1671997309, key: "anime", value: "One Piece")
        end
    ...
    describe '#deserialize_header' do
        ...
        let(:serialized_header_data) do 
            OpenStruct.new(raw: "\x1F\xAB\xA8c\n\x00\x00\x00\x14\x00\x00\x00", epoc: 1671998239, keysz: 10, valuesz: 20)
        end
